...
/* Error report: Error: Could not find or load main class Enigma1
 *    (Exlain the error(s) that occur here, in this comment,
 *    and fix the errors)
 *    Hint: What kinds of input are unacceptable? What kinds of
 *        acceptable input don't produce the correct answer?
 *    The [] in the main method were before arg not after it. Once they were moved, the program was able to compile          
 *    The output then did nothing but give the precent because it was taking 1-x. It really needed to be 100-x and then be in parenthases to make sure that operation is done first. 
 *    If not in parenthases, there will still be no output
 * 
 * 
 */
